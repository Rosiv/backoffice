CREATE TRIGGER Products_AfterUpdate_Trigger
...
BEGIN
	...
	('<Message Action="Product_Updated"><Product><Id>'+@id+'</Id><Name>'+@name+'</Name><Description>'+@description+'</Description></Product></Message>') 
